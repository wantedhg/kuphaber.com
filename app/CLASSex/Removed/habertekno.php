<?php
	...
	/**
	* RSS Yayını içinde 270 adet içerik olduğu ve
	* hepsini parse etmemiz durumunda 30 günlük limiti aşacağı için
	* sadece limit kadarını parse ediyoruz
	*/
			...
			if($adet > 0)
			{
				...
				for($i = 0; $i < $adet; $i++)
				{
 					...
 					if(!in_array($list[$i]['cache_link'], $list_url))
					{
						...
						$array_url  = array(
							'canli-izle',
							'http://www.habertekno.com/yazarlar/',
						);
						...
						//burda gün denetimi yapmak şart
						//çünkü rss yayını çok uzun ve çok eski tarihleri kapsıyor
